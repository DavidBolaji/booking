...
router
	.route('/bookings/edit/getavailability/halls/:hallname/from/:from/to/:to/id/:baseUrl')
...
router
	.route('/bins/restore/:id')
	.get(protect, binsController.restoreBooking)

router
	.route('/bins/:id')
	.delete(protect, binsController.deleteSingleBin)
